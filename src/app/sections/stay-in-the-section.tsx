  ...
  return (
    <section className="block bg-primary">
      <div className="flex py-16 px-6 flex-col items-center gap-16 mx-auto w-full max-w-screen max-md:py-10 max-md:px-4 max-md:gap-12">
        <div className="block [font-family:Denim,_serif] text-4xl font-semibold leading-[2.6875rem] tracking-[0.18px] text-center max-md:text-[1.75rem] max-md:leading-[2.125rem]" data-component="heading">
          <p className="block">
            {"Stay "}
            <br className="inline" />
            in the loop
        ...
        <div className="w-full h-[3.0625rem] block relative max-w-150 overflow-hidden align-middle" title="Newsletter signup form">
                    ...
                    <div className="box-content flex relative min-w-0 items-stretch">
                      <div className="box-content w-[252.7px] flex relative min-w-0 py-2 justify-start grow shrink-0 basis-0 bg-primary max-md:w-[7.7625rem]">
                        <div className="box-content flex min-w-0 flex-col self-end grow">
                          ...
                          <input className="w-full h-8 border border-solid border-clr-4 block min-w-0 pl-4 overflow-clip text-foreground [font-family:Denim,_Arial,_'Helvetica_Neue',_Helvetica,_sans-serif] font-medium text-left bg-primary" data-ditto-id="style-f0-first-name-01kckrfqt54pxhw5xnfew9dhw6" data-component="input" aria-invalid="false" id="f0-first_name_01KCKRFQT54PXHW5XNFEW9DHW6" placeholder="First name" type="text" />
                      ...
                      <div className="box-content w-[252.7px] flex relative min-w-0 py-2 justify-start grow shrink-0 basis-0 bg-primary max-md:w-[7.7625rem]">
                        <div className="box-content flex min-w-0 flex-col self-end grow">
                          ...
                          <input className="w-full h-8 border border-solid border-clr-4 block min-w-0 pl-4 overflow-clip text-foreground [font-family:Denim,_Arial,_'Helvetica_Neue',_Helvetica,_sans-serif] font-medium text-left bg-primary" data-ditto-id="style-f0-email-01kckrfqt9jp6xgnjy3fqm6maj" data-component="input" aria-invalid="false" aria-required="true" id="f0-email_01KCKRFQT9JP6XGNJY3FQM6MAJ" name="email" placeholder="Email address" type="email" />
                          <div className="box-content block relative min-w-0" />
                        </div>
                      </div>
        ...
        <div className="block max-w-150 mx-auto [font-family:Denim,_serif] font-medium leading-[1.375rem] tracking-[0.16px] text-center max-md:text-sm max-md:leading-[1.25rem] max-md:tracking-[0.14px]">
          <p className="block">
