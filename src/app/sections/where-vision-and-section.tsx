...
/** Where Vision And section. */
export default function WhereVisionAndSection() {
  return (
    <section className="block bg-foreground" id="full-width-test">
      <div className="h-200 min-h-160 block relative z-1 max-h-224 overflow-hidden w-full max-md:h-[43.3625rem] max-lg:min-h-0 max-lg:max-h-none md:max-lg:h-240 2xl:h-270 2xl:min-h-240 2xl:max-h-336">
        <div className="h-full block absolute top-0 inset-x-0 overflow-hidden">
          <div className="h-300 block absolute -top-100 inset-x-0 transform-[matrix(1,0,0,1,0,-16.2969)] max-md:h-[65.0375rem] max-md:top-[-346.9px] max-md:transform-[matrix(1,0,0,1,0,-14.4591)] md:max-lg:h-360 md:max-lg:-top-120 md:max-lg:transform-[matrix(1,0,0,1,0,-12.5769)] 2xl:h-405 2xl:-top-135 2xl:transform-[matrix(1,0,0,1,0,-13.8477)]">
