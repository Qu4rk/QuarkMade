  ...
  return (
    <section className="block bg-background py-24 md:py-32 px-6 max-md:py-16 max-md:px-4" id="philosophy">
      <div className="flex flex-col gap-8 mx-auto w-full max-w-4xl text-center">
        ...
        <div
          data-reveal
          className="[font-family:'Satoshi',_sans-serif] text-lg sm:text-xl md:text-2xl text-foreground/80 font-normal leading-relaxed max-w-3xl mx-auto"
        >
          <p className="block">
        ...
        <div
          data-reveal
          className="[font-family:'Satoshi',_sans-serif] text-base sm:text-lg md:text-xl text-foreground/60 font-normal leading-relaxed max-w-3xl mx-auto"
        >
          <p className="block">
