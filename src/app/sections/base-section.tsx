...
/** Studio Snapshot Gallery & Visual Archive using Aceternity Apple Cards Carousel. */
export default function BaseSection() {
  ...
  return (
    <section className="block bg-background py-20 md:py-28 px-4 sm:px-6 max-md:py-16 overflow-hidden" id="journal">
