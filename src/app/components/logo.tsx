...
export default function Logo({ d }: { d: LogoData }) {
  return (
    <a className="flex rounded-full justify-center items-center shrink-0 gap-2 [font-family:'Saans_Mono',_monospace] text-[0.8125rem] font-medium leading-[0.8125rem] tracking-[0.13px] uppercase whitespace-nowrap text-nowrap bg-surface [backdrop-filter:blur(12px)] cursor-pointer h-12 w-12 max-md:text-xs max-md:leading-[0.75rem] max-md:tracking-[0.12px] hover:bg-clr-6" data-component="link" href={d.href} rel="noopener noreferrer" target="_blank">
