...
export default function CardGridItem({ d }: { d: CardGridItemData }) {
  switch (d.variant) {
    case "base31-expands-its-public-art-program-with":
      return (
        <div className="w-[26rem] block min-w-0 pl-4 shrink-0 basis-1/3 max-md:w-[18.4875rem] max-md:pl-3 max-md:basis-5/6 md:max-lg:w-[20.4375rem] md:max-lg:basis-[44.44%] 2xl:w-[522.7px]">
          <a className="flex pb-8 flex-col gap-7 cursor-pointer max-md:pb-6 max-md:gap-5" data-component="link" href="/on-base-blog/base31-expands-its-public-art-program">
            <div className="block relative rounded-lg overflow-hidden aspect-[3/2] h-auto w-full max-md:rounded-md max-md:aspect-[4/3]">
              <div className="h-full block absolute top-0 inset-x-0 overflow-hidden max-md:hidden">
                <picture className="inline">
                  ...
                  <img className="w-100 h-[16.6875rem] block absolute overflow-clip object-cover align-middle md:max-lg:w-[19.4375rem] md:max-lg:h-[12.9375rem] 2xl:w-[31.6875rem] 2xl:h-84.5" data-component="image" alt="Art Walk" src="/assets/cloned/images/be381162fee4.png" />
                </picture>
              </div>
    ...
    case "understanding-the-base31-community-associa":
      return (
        <div className="w-[26rem] block min-w-0 pl-4 shrink-0 basis-1/3 max-md:w-[18.4875rem] max-md:pl-3 max-md:basis-5/6 md:max-lg:w-[20.4375rem] md:max-lg:basis-[44.44%] 2xl:w-[522.7px]">
          <a className="flex pb-8 flex-col gap-7 cursor-pointer max-md:pb-6 max-md:gap-5" data-component="link" href="/on-base-blog/understanding-the-base31-community-association">
            <div className="block relative rounded-lg overflow-hidden aspect-[3/2] h-auto w-full max-md:rounded-md max-md:aspect-[4/3]">
              <div className="h-full block absolute top-0 inset-x-0 overflow-hidden max-md:hidden">
                <picture className="inline">
                  ...
                  <img className="w-100 h-[16.6875rem] block absolute overflow-clip object-cover align-middle md:max-lg:w-[19.4375rem] md:max-lg:h-[12.9375rem] 2xl:w-[31.6875rem] 2xl:h-84.5" data-component="image" alt="Drone Shot Of Site" src="/assets/cloned/images/bc720b350a2b.jpg" />
                </picture>
              </div>
              <div className="w-full h-full hidden absolute top-0 overflow-hidden max-md:w-[17.7375rem] max-md:block">
    ...
    case "five-years-in-base31-builds-on-momentum-un":
      return (
        <div className="w-[26rem] block min-w-0 pl-4 shrink-0 basis-1/3 max-md:w-[18.4875rem] max-md:pl-3 max-md:basis-5/6 md:max-lg:w-[20.4375rem] md:max-lg:basis-[44.44%] 2xl:w-[522.7px]">
          <a className="flex pb-8 flex-col gap-7 cursor-pointer max-md:pb-6 max-md:gap-5" data-component="link" href="/on-base-blog/five-years-in">
            <div className="block relative rounded-lg overflow-hidden aspect-[3/2] h-auto w-full max-md:rounded-md max-md:aspect-[4/3]">
              <div className="h-full block absolute top-0 inset-x-0 overflow-hidden max-md:hidden">
                <picture className="inline">
                  ...
                  <img className="w-100 h-[16.6875rem] block absolute overflow-clip object-cover align-middle md:max-lg:w-[19.4375rem] md:max-lg:h-[12.9375rem] 2xl:w-[31.6875rem] 2xl:h-84.5" data-component="image" alt="Explaniner video" src="/assets/cloned/images/65f1a9b71dab.png" />
                </picture>
              </div>
            </div>
            <div className="flex pr-12 flex-col gap-4 max-md:pr-6 max-md:gap-3">
    ...
    case "continuing-the-evolution-of-base31":
      return (
        <div className="w-[26rem] block min-w-0 pl-4 shrink-0 basis-1/3 max-md:w-[18.4875rem] max-md:pl-3 max-md:basis-5/6 md:max-lg:w-[20.4375rem] md:max-lg:basis-[44.44%] 2xl:w-[522.7px]">
          <a className="flex pb-8 flex-col gap-7 cursor-pointer max-md:pb-6 max-md:gap-5" data-component="link" href="/on-base-blog/continuing-the-evolution-of-base31">
            <div className="block relative rounded-lg overflow-hidden aspect-[3/2] h-auto w-full max-md:rounded-md max-md:aspect-[4/3]">
              <div className="h-full block absolute top-0 inset-x-0 overflow-hidden max-md:hidden">
